...
export default function BasicFace({
  ...
  radius = 250,
  color,
  textureUrl = "https://i.ibb.co/gFMKwxmR/BACKLogo3.png", // СЮДА вставьте ссылку на текстуру
  hatUrl = "https://i.ibb.co/d4tfjJ1K/kapBot.png", // СЮДА вставьте ссылку на шапку
}: BasicFaceProps) {
