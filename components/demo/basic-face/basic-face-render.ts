...
// желаемый сдвиг по Y на канвасе
const desiredYOffset = -100;

// сначала позиция на канвасе (центр лица + сдвиг / масштаб)
ctx.translate(width / 2, height / 2 + desiredYOffset / hatScale);

// масштабируем шляпу
ctx.scale(hatScale, hatScale);

// компенсируем локальное смещение SVG
